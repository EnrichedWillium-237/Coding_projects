...
newbook1.save("payroll_crosschecks/payroll_crosscheck.xlsx")
...
print("\n")
print("file output written to final_payroll/payroll_crosscheck.xlsx")
print("\n")
print("Cross-check calculation completed\n")
